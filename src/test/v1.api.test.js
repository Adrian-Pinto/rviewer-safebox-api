      ...
      * : JSON with key id: String`, (done) => {
        chai.request(api)
          ...
          .send({
            ...
            expect(res.body).to.have.own.property('id').that.is.a('id');
            done();
          });
      });
    });
          ...
          .send({
            ...
            chai.request(api)
              ...
              .send({
                ...
                expect(res.text).to.be.equal('Safebox already exists');
                done();
              });
          });
      });
      ...
      * : Response text 'Requested endpoint does not exist'`, (done) => {
        chai.request(api)
          ...
          .end((err, res) => {
            ...
            expect(res.text).to.be.equal('Requested enpoint does not exist');
            done();
          });
      });
    });
